...
class instrumentPiano : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        keys = arrayOf(
            findViewById(R.id.C),
            findViewById(R.id.Cis),
            findViewById(R.id.D),
            findViewById(R.id.Dis),
            findViewById(R.id.E),
            findViewById(R.id.F),
            findViewById(R.id.Fis),
            findViewById(R.id.G),
            findViewById(R.id.Gis),
            findViewById(R.id.A),
            findViewById(R.id.B),
            findViewById(R.id.H),
            findViewById(R.id.C2),
            findViewById(R.id.Cis2),
            findViewById(R.id.D2),
            findViewById(R.id.Dis2),
            findViewById(R.id.E2),
            findViewById(R.id.F2),
            findViewById(R.id.Fis2),
            findViewById(R.id.G2),
            findViewById(R.id.Gis2),
